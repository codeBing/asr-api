...
package com.ecarx.asrapi.dto.nano;
...
public interface ASR {
	...
	public static final class APIRequest extends
		...
		// required .com.ecarx.asrapi.dto.APIReqType api_req_type = 1;
		public int apiReqType;

		// optional .com.ecarx.asrapi.dto.ApiParam param = 2;
		public com.ecarx.asrapi.dto.nano.ASR.ApiParam param;

		// optional .com.ecarx.asrapi.dto.ApiData data = 3;
		public com.ecarx.asrapi.dto.nano.ASR.ApiData data;

		// optional .com.ecarx.asrapi.dto.ApiLast last = 4;
		public com.ecarx.asrapi.dto.nano.ASR.ApiLast last;

		// optional .com.ecarx.asrapi.dto.ApiCancel cancel = 5;
		public com.ecarx.asrapi.dto.nano.ASR.ApiCancel cancel;

		// optional .com.ecarx.asrapi.dto.ApiThirdData third_data = 6;
		public com.ecarx.asrapi.dto.nano.ASR.ApiThirdData thirdData;
		...
		public APIRequest clear() {
			apiReqType = com.ecarx.asrapi.dto.nano.ASR.API_REQ_TYPE_PARAM;
			param = null;
			data = null;
			last = null;
			cancel = null;
		...
		public APIRequest mergeFrom(
			...
			while (true) {
				...
				case 8: {
					...
					switch (value) {
					case com.ecarx.asrapi.dto.nano.ASR.API_REQ_TYPE_PARAM:
					case com.ecarx.asrapi.dto.nano.ASR.API_REQ_TYPE_DATA:
					case com.ecarx.asrapi.dto.nano.ASR.API_REQ_TYPE_LAST:
					case com.ecarx.asrapi.dto.nano.ASR.API_REQ_TYPE_CANCEL:
					case com.ecarx.asrapi.dto.nano.ASR.API_REQ_TYPE_THIRD_DATA:
				...
				case 18: {
					if (this.param == null) {
						this.param = new com.ecarx.asrapi.dto.nano.ASR.ApiParam();
					}
				...
				case 26: {
					if (this.data == null) {
						this.data = new com.ecarx.asrapi.dto.nano.ASR.ApiData();
					}
				...
				case 34: {
					if (this.last == null) {
						this.last = new com.ecarx.asrapi.dto.nano.ASR.ApiLast();
					}
				...
				case 42: {
					if (this.cancel == null) {
						this.cancel = new com.ecarx.asrapi.dto.nano.ASR.ApiCancel();
					}
				...
				case 50: {
					if (this.thirdData == null) {
						this.thirdData = new com.ecarx.asrapi.dto.nano.ASR.ApiThirdData();
					}
	...
	public static final class ApiData extends
		...
		public ApiData clear() {
			len = 0;
			postData = com.google.protobuf.nano.WireFormatNano.EMPTY_BYTES;
			cachedSize = -1;
			return this;
		}
	...
	public static final class ApiThirdData extends
		...
		public ApiThirdData clear() {
			len = 0;
			thirdData = com.google.protobuf.nano.WireFormatNano.EMPTY_BYTES;
			type = "";
			cachedSize = -1;
			return this;
		}
	...
	public static final class APIResponse extends
		...
		// required .com.ecarx.asrapi.dto.APIRespType type = 1;
		public int type;
		...
		// optional .com.ecarx.asrapi.dto.ASRResult result = 5;
		public com.ecarx.asrapi.dto.nano.ASR.ASRResult result;

		// optional .com.ecarx.asrapi.dto.ApiThirdData third_data = 6;
		public com.ecarx.asrapi.dto.nano.ASR.ApiThirdData thirdData;

		// optional .com.ecarx.asrapi.dto.ApiHeart heart = 7;
		public com.ecarx.asrapi.dto.nano.ASR.ApiHeart heart;

		// optional .com.ecarx.asrapi.dto.ApiLast last = 8;
		public com.ecarx.asrapi.dto.nano.ASR.ApiLast last;
		...
		public APIResponse clear() {
			type = com.ecarx.asrapi.dto.nano.ASR.API_RESP_TYPE_MIDDLE;
			id = "";
			errNo = 0;
			errMsg = "";
			result = null;
		...
		public APIResponse mergeFrom(
			...
			while (true) {
				...
				case 8: {
					int value = input.readInt32();
					switch (value) {
					case com.ecarx.asrapi.dto.nano.ASR.API_RESP_TYPE_MIDDLE:
					case com.ecarx.asrapi.dto.nano.ASR.API_RESP_TYPE_RES:
					case com.ecarx.asrapi.dto.nano.ASR.API_RESP_TYPE_THIRD:
					case com.ecarx.asrapi.dto.nano.ASR.API_RESP_TYPE_HEART:
					case com.ecarx.asrapi.dto.nano.ASR.API_RESP_TYPE_LAST:
						this.type = value;
						break;
					}
					break;
				...
				case 42: {
					if (this.result == null) {
						this.result = new com.ecarx.asrapi.dto.nano.ASR.ASRResult();
					}
				...
				case 58: {
					if (this.heart == null) {
						this.heart = new com.ecarx.asrapi.dto.nano.ASR.ApiHeart();
					}
